...
{ 
    ...
    { 
        ...
        // Read first concatenated string from child
        char concat_str_child[200];
        read(fd2[0], concat_str_child, 200);
        printf("Output : %s\n", concat_str_child);

        // Read second string from child
        char input_str_child[200];
        read(fd2[0], input_str_child, 200);
        
        // Concatenate: first result + second input + "gobison.org"
        char final_str[400];
        strcpy(final_str, concat_str_child);
        strcat(final_str, input_str_child);
        strcat(final_str, fixed_str_parent);
        printf("Input : %s Output : %s\n", input_str_child, final_str);
    ...
    { 
        ...
        // Send this string back to parent
        write(fd2[1], input_str_child, strlen(input_str_child) + 1);
        close(fd2[1]);
